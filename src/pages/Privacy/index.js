...
<p>Information that is <span style={{'font-weight': '700',color: '#523178'}}>about you</span> is information that describes you
...
<p>If someone else has this information they would be able to steal your identity — causing you problems IRL (in real life) as well as online.</p>
        ...
        >
          ...
          <p>Information that <span style={{'font-weight': '700',color: '#523178'}}>is you</span> may be
...
<br /> <br/><span style={{'font-weight': '700',color: '#523178'}}>This information is you.</span>  </p>
<ul style={{listStylePosition: "outside"}}>
  <li>
    Thought Processes
  </li>
