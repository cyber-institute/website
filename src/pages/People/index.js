  ...
  <>
      ...
      <div>
            ...
            <div className="row around-xs" style={{position: 'relative', top: '75px'}}>
              <div className="col-xs-12 col-md-5 first-md" style={{paddingTop: '20px', left: "0"}}>
                <p>Ree joined the Cyber Institute in late 2018 from the Bureau of Meteorology (BoM) where she held a 
                  ...
                  facilitation, program delivery, governance and change management.  Ree is the Cyber Institute’s COO. </p>
                <h3>COO, Ree Kent</h3>
              </div>
              <div className="col-xs-12 col-md-5 first-xs" style={{position: 'relative', right: "0"}}>
                ...
                <hr className="greyLine" style={{position: 'absolute', top: '50%', right: '-38%', width: '150%', zIndex: "-20"}} />
              </div> 
            </div>
          </div>
        </div>
        <hr className="purpleDash" style={{position: 'relative', top: '195px', marginLeft: "0"}} />
        <div className="mainBody" style={{top: '60px'}}>
        ...
        <div style={{width: '100%', position: 'relative', paddingTop: '75px', marginTop: '10px'}}>
          <div className="mainBody">
            ...
            <p><br />Here are some of our fantastic team members this month, who make the Cyber Institute, its research, 
              education, innovation and delivery programs happen:&nbsp;</p>
            <div className="row around-xs" style={{marginTop: '50px'}}>
              <div className="col-xs-9 col-md-3" style={{position: 'relative', right: "0"}}>
                ...
                <hr className="greyLine" style={{position: 'absolute', top: '25%', left: '-80%', width: '200%', zIndex: "-20"}} />
              </div> 
            ...
            <div className="row around-xs" style={{marginTop: '50px'}}>
              <div className="col-xs-12 col-md-7 first-md" style={{paddingTop: '20px', left: "0"}}>
                ...
                <p>Meet Brendan who started with the Cyber Institute in January of 2019. 
                  ...
                  the ANU, with a focus in human biology, Australian Indigenous studies and anthropology.</p>
              </div>
              <div className="col-xs-9 col-md-3 first-xs" style={{position: 'relative', right: "0"}}>
                ...
                <hr className="greyLine" style={{position: 'absolute', top: '50%', right: '-63%', width: '200%', zIndex: "-20"}} />
              </div> 
            </div>
          </div>
        </div>
        <div className="careersContainer">
          ...
          <div className="mainBody" style={{paddingTop: '100px', paddingBottom: '175px'}}>
            <div className="row around-xs">
              <div className="col-xs-12 col-md-5 first-md">
                ...
                <p style={{paddingTop: '25px'}} ><span className="bigEmphasis">Imagine</span> a place where we think about cyber differently, where we bring together deep expertise 
                  ...
                  but informed decisions about systems and strategy, data and development, and culture and capability...</p>
                ...
                <p>To be part of, and help guide, our journey and mission to ensure the challenge of cyber is met to the 
                  betterment of humanity, <span style={{fontWeight: 'bold', fontSize: '24px'}}>we are seeking those willing to tackle a challenge, go beyond traditional 
                  ...
                  in becoming part of out team, we invite you to send your CV to <a href="mailto:cyber@anu.edu.au" style={{color: '#D2AcF7'}}>cyber@anu.edu.au</a>.</p>
              </div>
      ...
      <div className="mainBody">
        ...
        <p>The Cyber Institute is governed under the Australian National University Act 1991 and the Public Governance, Performance &amp; Accountability Act 2013.&nbsp;&nbsp;
          ...
          <br /><br />
          The Advisory Board is chaired by the Vice Chancellor, Nobel Laureate Professor Brian Schmidt.</p>
        <div id="team" className="col-xs-12">
          <div className="row">
          <div className="col-xs-3"></div>
          <div className="member col-xs-2">

            <img src={Brian} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">Professor Brian P. Schmidt AC FAA FRS </div>
                <div className="title">Vice-Chancellor and President, The Australian National University</div>
                <div className="desc">2011 Nobel Laureate Physics</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
          ...
          <div className="member col-xs-2">
            <img src={Elanor} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">Professor Elanor Huntington</div>
                <div className="title">Dean, College of Engineering &amp; Computer Science, The Australian National University</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
          ...
          <div className="member col-xs-2">
            <img src={Rory} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">Professor Rory Medcalf</div>
                <div className="title">Head of the National Security College, The Australian National University</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
          ...
          <div className="member col-xs-2">
            <img src={Marie} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">Ms. Marie Johnson</div>
                <div className="title">Managing Director and Chief Digital Officer</div>
                <div className="desc">Centre for Digital Business</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
          ...
          <div className="member col-xs-2">
            <img src={Hamish} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">Mr. Hamish Hawthorn</div>
                <div className="title">COO, UpGuard</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
          ...
          <div className="member col-xs-2">
            <img src={Deb} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">Ms. Deborah Anton</div>
                <div className="title">Interim National Data Commissioner</div>
                <div className="desc">Department of the Prime Minister and Cabinet</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
          ...
          <div className="member col-xs-2">
            <img src={Mick} className='img-fluid w-100' style={{maxWidth : "90%", "margin": "2rem", height:"80%"}}/>
            <div className="hover">
              <div>
                <div className="name">MAJGEN Mick Ryan</div>
                <div className="title">Major General at Australian Army</div>
              </div>
            </div>
            <div className="content UIHTMLContent">
              <div className="mainBody">
