    ...
    <>
         <BlackSlider name = {title}>
             <div className="col-md-offset-1 col-md-10">
                <div className="col-md-offset-1 col-md-10">
                    <p>Currently in development. Please email <a style={{color: '#523178', fontWeight: '700'}}>cyber@anu.edu.au</a> to register your interest in this course. </p>
                </div>
        </div>
         </BlackSlider>
